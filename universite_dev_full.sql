...
INSERT INTO `cours` VALUES (1,'Programmation Java','CS101',6),(2,'Algèbre Linéaire','MATH201',5),(3,'Bases de Données','CS102',6),(4,'Programmation Python',NULL,3);
...
CREATE TABLE `enseignement` (
  ...
  `semestre` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `inscription` VALUES (1,1,1,'2025-09-01'),(1,2,2,'2025-09-02'),(2,1,1,'2025-09-01'),(2,2,2,'2025-09-02');
...
CREATE TABLE `professeur` (
  ...
  `departement` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`)
...
-- Dump completed on 2025-12-28 15:50:05
